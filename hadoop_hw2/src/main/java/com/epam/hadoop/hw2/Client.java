...
public class Client {
    ...
    public boolean run() throws IOException, YarnException {
        ...
        String command = Arrays.asList(Environment.JAVA_HOME.$$() + "/bin/java",
                "-Xmx" + amMemory + "m",
                appMasterMainClass,
//                "--container_memory " + String.valueOf(containerMemory),
//                "--container_vcores " + String.valueOf(containerVirtualCores),
//                "--num_containers " + String.valueOf(numContainers),
//                "--priority " + String.valueOf(shellCmdPriority),
                "--input " + input,
                "--output " + output,
